                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="{{ asset('/admin/assets/img/customer/user-05.jpg') }}" alt="User Image"> Annette Silva
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="{{ asset('/admin/assets/img/customer/user-06.jpg') }}" alt="User Image"> Stephen Wilson</td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="{{ asset('/admin/assets/img/customer/user-07.jpg') }}" alt="User Image"> Ryan Rodriguez</td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="{{ asset('/admin/assets/img/customer/user-08.jpg') }}" alt="User Image"> Lucile Devera
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="{{ asset('/admin/assets/img/customer/user-09.jpg') }}" alt="User Image"> Roland Storey</td>
